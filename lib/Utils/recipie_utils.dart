List<Map<String, dynamic>> allRecipies = [
  ...
  },
  {
    ...
    "userId": 39,
    "image":
        "https://www.inspiredtaste.net/wp-content/uploads/2023/11/Fluffy-Spanish-Rice-1-1200.jpg",
    "rating": 5,
    "reviewCount": 34,
    "mealType": ["Lunch", "Dinner"]
  },
...
List<Map<String, dynamic>> FavoriteRecipies = [];

List<Map<String, dynamic>> MyRecipies = [];
